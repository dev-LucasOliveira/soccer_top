...
export const metadata = buildModeLandingMetadata("tradicional");
...
export default function TradicionalPage() {
  return (
    <>
      <ModeLandingPage modeId="tradicional">
        <div className="space-y-4 text-center">
          <p className="text-sm text-on-pitch-muted">
            Configure rodadas no lobby e convide amigos pelo link da sala.
          </p>
          <Link
            href="/"
      ...
      <ModeLandingSeo modeId="tradicional" />
    </>
  );
}
