...
import { applyListaSecretaMpPick } from "@/lib/lista-secreta-mp-session";
...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const result = await applyListaSecretaMpPick(
      code,
      participantId,
      guestToken ?? null,
      playerId
    ...
    console.error("lista-secreta pick error:", error);
    return NextResponse.json(
